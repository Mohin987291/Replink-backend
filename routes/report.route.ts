...
import { getReportsByGigIdHandler, createReportHandler, getReportByCompanyIdHandler, getReportsByRepIdHandler } from "../controllers/report.controller.js";
...
export const reportRoutes = async (fastify: FastifyInstance) => {
  ...
  fastify.get("/rep/:repId/reports", getReportsByRepIdHandler);
}